...
public class Ranking {
	...
	private ArrayList<Install_Chromosome>[] ranking_  ;
	
	Ranking(ArrayList<Install_Chromosome> union){
		 ...
		 int [] dominateMe = new int[union.size()];
		    ...
		    for (int j = 0; j < i; j++) {
		      ranking_[j] = new ArrayList<Install_Chromosome>(front[j].size());
	...
	public static int compare(Install_Chromosome chromosome1, Install_Chromosome chromosome2) {
	...
	public ArrayList<Install_Chromosome> getSubfront(int rank) {
